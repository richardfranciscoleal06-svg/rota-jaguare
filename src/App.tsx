...
import { Menu, Shield, Command } from 'lucide-react';
...
function AppInner() {
  ...
  const handleRegister = (data: Omit<PendingRegistration, 'id' | 'dataSolicitacao'>) => {
    setShowLogin(false);
    setToast(
          ...
          <div className="md:hidden sticky top-0 z-30 bg-rota-dark border-b border-rota-border flex items-center justify-between px-4 h-14">
            ...
            <div className="flex items-center gap-2">
              {view === 'comando' ? (
                ...
                <Shield className="w-4 h-4 text-rota-gold" />
              )}
