...
const stats = [
  { label: 'Drogas Apreendidas', value: '1.247', unit: 'porções', icon: Pill, color: 'text-rota-gold' },
  { label: 'Armamentos', value: '382', unit: 'unidades', icon: Crosshair, color: 'text-rota-red-light' },
  { label: 'Munições', value: '8.450', unit: 'projéteis', icon: Package, color: 'text-rota-light' },
  { label: 'Bombas', value: '47', unit: 'artefatos', icon: Bomb, color: 'text-rota-red-light' },
  { label: 'Dinheiro Marcado', value: 'R$ 2.4M', unit: 'contabilizado', icon: DollarSign, color: 'text-rota-gold' },
  { label: 'Operadores Ativos', value: '15', unit: 'militares', icon: Users, color: 'text-rota-green-light' },
];

const highlights = [
  { label: 'Ocorrências no mês', value: '342', icon: Activity, trend: '+12%' },
  { label: 'Patrulhas realizadas', value: '186', icon: Shield, trend: '+8%' },
  { label: 'Taxa de resolução', value: '94%', icon: TrendingUp, trend: '+3%' },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <div className="px-4 py-2 rounded-lg bg-rota-card border border-rota-border">
              ...
              <p className="text-lg font-bold text-rota-green-light">3 viaturas ativas</p>
            </div>
            <div className="px-4 py-2 rounded-lg bg-rota-card border border-rota-border">
              <span className="text-xs text-rota-muted uppercase tracking-wide">Última atualização</span>
              <p className="text-lg font-bold text-rota-white">20/09/2026</p>
            </div>
          </div>
        </div>
      </section>
